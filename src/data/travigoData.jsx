...
import standardicon from "../images/standart.png";
import mediumicon from "../images/medium.png";
import preminumicon from "../images/premium.png";
...
export const placesAPI = [
  { "placeImg": place1, "location": "Istanbul", "distance": "3.0 hour drive" },
  { "placeImg": place2, "location": "London", "distance": "2.5 hour drive" },
  { "placeImg": place3, "location": "Paris", "distance": "4.7 hour drive" },
  { "placeImg": place4, "location": "Rome", "distance": "4 hour drive" },
  { "placeImg": place5, "location": "New Zealand", "distance": "4.9 hour drive" },
  { "placeImg": place6, "location": "Tahiti", "distance": "4.5 hour drive" },
  { "placeImg": place7, "location": "Tokyo", "distance": "5.5 hour drive" },
  { "placeImg": place8, "location": "Barcelona", "distance": "5.1 hour drive" },
  { "placeImg": place9, "location": "Banff", "distance": "5.1 hour drive" },
  { "placeImg": place10, "location": "Dubai", "distance": "5.1 hour drive" },
];
  ...
  "plans": [
    {
      ...
      "plancontent": [
        ...
        { "iconbox": uncheckbox, "text": "Invite Friends Feature" },
        { "iconbox": uncheckbox, "text": "Ads & Tax" },
      ],
      "buttonText": "Get Free",
    },
    {
